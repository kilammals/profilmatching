    ...
    <!-- <h1>Contoh SPK GAP MP</h1> -->
		...
		?>
             ...
             <?php
				...
				arsort($nilai_akhir);
				//print_r($nilai_akhir);
				mysqli_query($koneksi, "DELETE FROM tbl_hasil");
			 ?>
                        
                        <h3>Nilai Akhir Total Sorting</h3>
                        <br>
    					<a href="print.php" target="blank"><input type="button" value="Cetak" class="btn btn-primary"></a>
    					<br><br>
                        <table class="table">
                        	<tr>
                            	<th>No</th>
            			...
            			<?php	
								...
								mysqli_query($koneksi, "INSERT INTO tbl_hasil(nama_karyawan,nilai) VALUES ('$nama_karyawan[$k]', '$nilai_akhir[$k]')");				
							}
						?>
        				</table>
        				<hr />
